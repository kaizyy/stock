    ...
    def do_GET(self):
        ...
        if path in ("/", "/index.html"):
            ...
            content = content.replace(
                "</body>",
                '<script src="/settings.js?v=20260824-5"></script><script src="/features.js?v=20260824-5"></script><script src="/features_optional_fix.js?v=20260824-5"></script><script src="/role_dashboard.js?v=20260824-5"></script></body>'
            )
