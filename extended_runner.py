    ...
    def do_GET(self):
        ...
        if path in ("/", "/index.html"):
            ...
            content = content.replace(
                "</body>",
                '<script src="/settings.js?v=20260825-4"></script><script src="/features.js?v=20260825-4"></script><script src="/features_optional_fix.js?v=20260825-4"></script><script src="/role_dashboard.js?v=20260825-4"></script><script src="/average_sale_price.js?v=20260825-4"></script><script src="/analytics_dashboard.js?v=20260825-4"></script><script src="/inventory_intelligence.js?v=20260825-4"></script><script src="/crm_orders.js?v=20260825-4"></script></body>'
            )
