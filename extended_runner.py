...
class ExtendedHandler(app_runner.AppHandler):
    ...
    def do_GET(self):
        ...
        if path in ("/","/index.html"):
            ...
            content=(server.PUBLIC_DIR/"index.html").read_text(encoding="utf-8");content=content.replace("</body>",'<script src="/settings.js?v=20260829-6"></script><script src="/settings_tools.js?v=20260829-6"></script><script src="/features.js?v=20260829-6"></script><script src="/features_optional_fix.js?v=20260829-6"></script><script src="/role_dashboard.js?v=20260829-6"></script><script src="/analytics_dashboard.js?v=20260829-6"></script><script src="/inventory_intelligence.js?v=20260829-6"></script><script src="/barcode_scanner_fallback.js?v=20260829-6"></script><script src="/dynamic_navigation.js?v=20260829-6"></script><script src="/crm_orders.js?v=20260829-6"></script><script src="/order_delete_ui.js?v=20260829-6"></script><script src="/warehouse_ops.js?v=20260829-6"></script><script src="/business_tools.js?v=20260829-6"></script><script src="/platform_admin_ui.js?v=20260829-6"></script><script src="/billing_ui.js?v=20260829-6"></script></body>');self.send_html(200,content);return
