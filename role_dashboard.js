(() => {
  ...
  style.textContent = `
    ...
    body[data-dashboard-role="buyer"] #outstandingValue,
    body[data-dashboard-role="buyer"] #outstandingCount,
    ...
    body[data-dashboard-role="seller"] #expectedCount,
    body[data-dashboard-role="seller"] #expectedCount + span,
    ...
    body[data-dashboard-role="viewer"] #outstandingValue,
    body[data-dashboard-role="viewer"] #outstandingCount,
