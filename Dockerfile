...
COPY index.html styles.css app.js dashboard_metrics.js settings.js settings_tools.js security_integrations_ui.js backup_status_ui.js platform_v2_ui.js documents_v2_ui.js documents_v3_ui.js features.js features_optional_fix.js role_dashboard.js analytics_dashboard.js inventory_intelligence.js barcode_scanner_fallback.js crm_orders.js order_delete_ui.js dynamic_navigation.js warehouse_ops.js business_tools.js platform_admin_ui.js billing_ui.js /app/public/
...
RUN ASSET_VERSION="$(date +%s)" \
    ...
    && printf '\nimport("/documents_v2_ui.js?v=%s").catch(()=>{});\nimport("/documents_v3_ui.js?v=%s").catch(()=>{});\n' "$ASSET_VERSION" "$ASSET_VERSION" >> /app/public/crm_orders.js \
