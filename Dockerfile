...
RUN apk add --no-cache curl su-exec postgresql-client \
    && pip install --no-cache-dir "psycopg[binary]>=3.2,<4" "psycopg-pool>=3.2,<4" "reportlab>=4.2,<5"

COPY server.py runner.py dashboard_runner.py app_runner.py order_management.py order_delete.py warehouse_ops.py business_tools.py platform_admin.py billing.py account_tools.py email_events.py security_integrations.py backup_status.py documents_v2.py documents_v3.py financial_workflow.py performance_backend.py v11_integrations.py extended_runner.py /app/
COPY index.html styles.css app.js performance_frontend.js dashboard_metrics.js settings.js settings_tools.js security_integrations_ui.js backup_status_ui.js documents_v2_ui.js documents_v3_ui.js financial_workflow_ui.js platform_v2_ui.js features.js features_optional_fix.js role_dashboard.js analytics_dashboard.js inventory_intelligence.js barcode_scanner_fallback.js crm_orders.js order_delete_ui.js dynamic_navigation.js warehouse_ops.js business_tools.js platform_admin_ui.js billing_ui.js /app/public/
...
CMD ["python", "-c", "import performance_backend; performance_backend.install(); import security_integrations; security_integrations.install(); import documents_v3; documents_v3.install(); import financial_workflow; financial_workflow.install(); import v11_integrations; v11_integrations.install(); import email_events; email_events.install(); import runpy; runpy.run_path('/app/extended_runner.py', run_name='__main__')"]
