...
COPY server.py runner.py dashboard_runner.py /app/
COPY index.html styles.css app.js settings.js features.js /app/public/
...
CMD ["python", "/app/dashboard_runner.py"]
