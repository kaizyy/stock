...
COPY server.py runner.py dashboard_runner.py app_runner.py order_management.py order_delete.py warehouse_ops.py business_tools.py platform_admin.py billing.py account_tools.py email_events.py extended_runner.py /app/
...
CMD ["python", "-c", "import email_events; email_events.install(); import runpy; runpy.run_path('/app/extended_runner.py', run_name='__main__')"]
