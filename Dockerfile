...
CMD ["python", "-c", "import csrf_auth_fix; csrf_auth_fix.install(); import security_integrations; security_integrations.install(); import documents_v3; documents_v3.install(); import stockroom_settings; stockroom_settings.install(); import v11_integrations; v11_integrations.install(); import financial_workflow; financial_workflow.install(); import email_events; email_events.install(); import runpy; runpy.run_path('/app/extended_runner.py', run_name='__main__')"]
