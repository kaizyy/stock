...
def check_web_feature_parity() -> None:
    ...
    require(index, ['id="movementPanel"', 'id="movementEntries"', 'id="movementReservations"', 'id="downloadMovements"', 'inventory_movements.js?v='], "Voorraadmutaties per artikel")
    require(movements, ["entriesFor", "reservation?.sources", "warehouseHistory", "Voorraadcorrectie", "csvFor", "downloadCsv"], "Voorraadmutaties, reserveringen en CSV-export")
