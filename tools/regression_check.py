...
def check_web_feature_parity() -> None:
    ...
    require(read("cashflow_forecast_ui.js"), ["analyticsContent", "cashflowPanel", "/api/cashflow-forecast", "Saldo na", "Conservatief", "Optimistisch", "data-cash-scenario", "Losse uitgaande transactie", "Losse inkomende transactie", "reliableLoad", "loadPromise", "MutationObserver"], "Betrouwbaar ladende kasstroomscenario's, losse transacties en grafiek")
