...
def check_web_feature_parity() -> None:
    ...
    require(read("cashflow_forecast.py"), ["cashflow_settings", "minimum_buffer", "sales_invoice", "purchase_invoice", "payment_batch", "purchase_order", "recurring_costs", "manual_sale", "manual_purchase", "orderId", "conservative", "optimistic"], "Kasstroomprognose 30/60/90 met losse transacties")
