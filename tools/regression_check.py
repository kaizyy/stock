...
def check_web_feature_parity() -> None:
    ...
    require(read("cashflow_forecast_ui.js"), ["cashflowPanel", "/api/cashflow-forecast", "Saldo na", "Conservatief", "Optimistisch", "data-cash-scenario", "Losse uitgaande transactie", "Losse inkomende transactie"], "Kasstroomscenario's, losse transacties en grafiek")
