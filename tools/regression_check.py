...
def check_web_feature_parity() -> None:
    ...
    require(read("purchase_approvals.py"), ["purchase_policies", "approval_threshold", "monthly_budget", "def evaluate", "def decide", "def send_order", "add_attachment", "purchase.order_emailed", "purchase.{approval}"], "Inkoopgoedkeuring, mail en budgetbeleid")
    require(read("purchase_approval_ui.js"), ["purchasePolicy", "/api/purchase-policy", "data-approve-order", "data-reject-order", "data-mail-purchase", "PDF mailen & bestellen", "Wacht op goedkeuring"], "Goedkeurings- en mailbediening")
