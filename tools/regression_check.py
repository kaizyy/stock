...
def check_web_feature_parity() -> None:
    ...
    require(read("navigation_registry.js"), ["StockroomNavigationRegistry", "resolveFeature", "auditDom", "stockroom:navigation-audit", "overview", "analytics", "inventory", "warehouse", "incoming", "outgoing", "relations", "orders", "quotes", "finance", "settings", "notifications", "platform-admin", "members", "sales-invoices", "debtors", "purchase-invoices", "payment-batches", "bank-reconciliation"], "Centraal navigatieregister zonder zichtbare herindeling")
