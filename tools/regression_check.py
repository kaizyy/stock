...
def check_web_feature_parity() -> None:
    ...
    require(read("platform_admin.py"), ["def action_center", "inventory_counts", "late-delivery", "purchase-approval:", "supplier-confirmation:", "confirmed-delay:", "supplier-shortage:", "quote-followup", "reservation:", "return:", "supplier-claim:", "wacht op verwerking"], "Actiebronnen en rolfiltering")
