...
def check_web_feature_parity() -> None:
    ...
    require(read("purchase_approvals.py"), ["purchase_policies", "approval_threshold", "monthly_budget", "def evaluate", "def decide", "def send_order", "def confirm_delivery", "confirmed_delivery_date", "purchase.supplier_confirmed", "add_attachment", "purchase.order_emailed", "purchase.{approval}"], "Inkoopgoedkeuring, bevestiging, mail en budgetbeleid")
    require(read("purchase_approval_ui.js"), ["purchasePolicy", "/api/purchase-policy", "data-approve-order", "data-reject-order", "data-mail-purchase", "data-confirm-purchase", "Bevestiging registreren", "PDF mailen & bestellen", "Wacht op goedkeuring"], "Goedkeurings-, bevestigings- en mailbediening")
    ...
    require(read("platform_admin.py"), ["def action_center", "inventory_counts", "late-delivery", "purchase-approval:", "supplier-confirmation:", "confirmed-delay:", "quote-followup", "reservation:", "return:", "supplier-claim:", "wacht op verwerking"], "Actiebronnen en rolfiltering")
