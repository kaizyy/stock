...
def check_web_feature_parity() -> None:
    ...
    require(read("order_returns.py"), ["order_returns", "order_return_lines", "fulfilled_quantity", "rma_number", "return_sequences", "def label_pdf", "def process", "def create_credit"], "Gekoppelde orderretouren en labels")
    require(read("return_management.js"), ["returnDialog", "/api/orders/returns", "data-return-action", "return.pdf", "Creditnota maken"], "Retourbediening")
    ...
    require(read("platform_admin.py"), ["def action_center", "inventory_counts", "late-delivery", "quote-followup", "reservation:", "return:", "wacht op verwerking"], "Actiebronnen en rolfiltering")
